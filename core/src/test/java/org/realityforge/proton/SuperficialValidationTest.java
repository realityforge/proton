...
public final class SuperficialValidationTest {
    ...
    @Test
    public void isTypeOf_returnsFalseForNullType() throws Throwable {
    ...
    private static boolean invokeIsTypeOf(final Class<?> clazz, final TypeMirror type) throws Throwable {
    ...
    private static final class FakeNullType implements NullType {
        @Override
