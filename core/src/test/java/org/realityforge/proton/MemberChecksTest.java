...
public final class MemberChecksTest
{
  ...
  public void messageHelpersFormatAnnotationNamesAndSuppressionInstructions()
  {
    ...
    assertEquals( MemberChecks.suppressedBy( "warning" ),
                  "This warning can be suppressed by annotating the element with @SuppressWarnings( \"warning\" )" );
    assertEquals( MemberChecks.suppressedBy( "warning", "com.example.AltSuppress" ),
                  "This warning can be suppressed by annotating the element with @SuppressWarnings( \"warning\" ) " +
                  "or @AltSuppress( \"warning\" )" );
  }

  @Test
  public void memberChecksValidateModifiersSignaturesAnnotationsAndWarnings()
    throws Exception
  {
    final MemberProcessor processor = new MemberProcessor();

    TestUtil.compile( List.of( TestUtil.source( "com.example.MemberTarget", """
      package com.example;
  ...
  private static final class MemberProcessor
    extends TestUtil.TestProcessor
  {
    ...
    private void validatePassingChecks( @Nonnull final TypeElement target )
    {
      ...
      MemberChecks.verifyNoOverlappingAnnotations( allowedOverlap,
    ...
    {
      assertFails( () -> MemberChecks.mustBeStatic( SCOPE, method( target, "publicMethod" ) ),
                   method( target, "publicMethod" ),
                   "@Scope target must be static" );
      assertFails( () -> MemberChecks.mustNotBeStatic( SCOPE, method( target, "staticMethod" ) ),
                   method( target, "staticMethod" ),
                   "@Scope target must not be static" );
      assertFails( () -> MemberChecks.mustBeAbstract( SCOPE, method( target, "protectedMethod" ) ),
                   method( target, "protectedMethod" ),
                   "@Scope target must be abstract" );
      assertFails( () -> MemberChecks.mustNotBeAbstract( SCOPE, method( target, "abstractMethod" ) ),
                   method( target, "abstractMethod" ),
                   "@Scope target must not be abstract" );
      assertFails( () -> MemberChecks.mustBeFinal( SCOPE, method( target, "protectedMethod" ) ),
                   method( target, "protectedMethod" ),
                   "@Scope target must be final" );
      assertFails( () -> MemberChecks.mustNotBeFinal( SCOPE, method( target, "finalMethod" ) ),
                   method( target, "finalMethod" ),
                   "@Scope target must not be final" );
      assertFails( () -> MemberChecks.mustNotBePublic( SCOPE, method( target, "publicMethod" ) ),
                   method( target, "publicMethod" ),
                   "@Scope target must not be public" );
      assertFails( () -> MemberChecks.mustBeProtected( SCOPE, method( target, "publicMethod" ) ),
                   method( target, "publicMethod" ),
                   "@Scope target must be protected" );
      assertFails( () -> MemberChecks.mustNotBeProtected( SCOPE, method( target, "protectedMethod" ) ),
                   method( target, "protectedMethod" ),
                   "@Scope target must not be protected" );
      assertFails( () -> MemberChecks.mustNotBePrivate( SCOPE, method( target, "privateMethod" ) ),
                   method( target, "privateMethod" ),
                   "@Scope target must not be private" );
      assertFails( () -> MemberChecks.mustNotBePackageAccessInDifferentPackage( target,
                                                                                SCOPE,
                                                                                SCOPE,
      ...
      assertFails( () -> MemberChecks.mustNotHaveAnyParameters( SCOPE, method( target, "parameterMethod" ) ),
                   method( target, "parameterMethod" ),
                   "@Scope target must not have any parameters" );
      assertFails( () -> MemberChecks.mustNotHaveAnyTypeParameters( SCOPE, method( target, "typeParameterMethod" ) ),
                   method( target, "typeParameterMethod" ),
                   "@Scope target must not have any type parameters" );
      assertFails( () -> MemberChecks.mustNotReturnAnyValue( SCOPE, method( target, "valueMethod" ) ),
                   method( target, "valueMethod" ),
                   "@Scope target must not return a value" );
      assertFails( () -> MemberChecks.mustReturnAValue( SCOPE, method( target, "protectedMethod" ) ),
                   method( target, "protectedMethod" ),
                   "@Scope target must return a value" );
      assertFails( () -> MemberChecks.mustNotThrowAnyExceptions( SCOPE, method( target, "throwsMethod" ) ),
                   method( target, "throwsMethod" ),
                   "@Scope target must not throw any exceptions" );
      assertFails( () -> MemberChecks.verifyNoOverlappingAnnotations( method( target, "overlapping" ),
                                                                      List.of( "com.example.One",
                                                                               "com.example.Two",
                                                                               "com.example.Three" ),
    ...
    private void validateWarningEmission( @Nonnull final TypeElement target )
    {
      ...
      final ProcessingEnvironment env =
        TestUtil.proxy( ProcessingEnvironment.class, ( self, method, args ) -> {
      ...
      MemberChecks.shouldNotBePublic( env,
                                      method( target, "publicMethod" ),
                                      SCOPE,
      ...
      assertEquals( messager.messages().get( 0 ).message(),
      ...
      MemberChecks.shouldNotBePublic( env,
                                      method( target, "publicSuppressed" ),
                                      SCOPE,
                                      Diagnostic.Kind.WARNING,
                                      "public-method" );
      assertEquals( messager.messages().size(), 1 );
    ...
    {
      MemberChecks.mustReturnAnInstanceOf( processingEnv, method( target, "valueMethod" ), SCOPE, "java.lang.String" );
      assertFails( () -> MemberChecks.mustReturnAnInstanceOf( processingEnv,
                                                              method( target, "valueMethod" ),
                                                              SCOPE,
                                                              "java.lang.Integer" ),
                   method( target, "valueMethod" ),
                   "@Scope target must return an instance of java.lang.Integer" );
      assertFalse( MemberChecks.doesMethodNotOverrideInterfaceMethod( processingEnv, target, method( target, "api" ) ) );
      assertTrue( MemberChecks.doesMethodNotOverrideInterfaceMethod( processingEnv,
                                                                     target,
                                                                     method( target, "parameterMethod" ) ) );
    }
  ...
  private static void assertFails( @Nonnull final CheckedAction action,
  ...
  private static final class CapturingMessager
    implements Messager
  {
    @Nonnull
