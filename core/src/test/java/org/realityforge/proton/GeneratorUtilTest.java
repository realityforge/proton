...
public final class GeneratorUtilTest {
    ...
    public void generatedClassNameHelpersIncludeNestedClassPrefixes() {
        ...
        assertEquals(
                GeneratorUtil.getGeneratedSimpleClassName(nested, "Generated", "Impl"), "Outer_GeneratedInnerImpl");
        assertEquals(
                GeneratorUtil.getGeneratedClassName(nested, "Generated", "Impl").toString(),
    ...
    private static final class GeneratorProcessor extends TestUtil.TestProcessor {
        ...
        private void validateNameHelpers(final TypeElement target) {
            ...
            assertEquals(
                    GeneratorUtil.getGeneratedSimpleClassName(target, "Generated", "Impl"),
                    "GeneratedGeneratorTargetImpl");
            assertEquals(
                    GeneratorUtil.getGeneratedClassName(target, "Generated", "Impl")
                            .toString(),
                    "com.example.GeneratedGeneratorTargetImpl");
            assertEquals(
                    GeneratorUtil.getGeneratedSimpleClassName(nested, "Generated", "Impl"),
                    "GeneratorTarget_GeneratedNestedImpl");
            assertEquals(
                    GeneratorUtil.getGeneratedClassName(nested, "Generated", "Impl")
                            .toString(),
                    "com.example.GeneratorTarget_GeneratedNestedImpl");
            assertEquals(
                    GeneratorUtil.getTypeArgumentsAsNames((DeclaredType) target.asType())
                            .get(0)
                            .name(),
                    "T");
        }
        ...
        private void validateAnnotationCopyHelpers(final TypeElement target) {
            ...
            final List<String> typeAnnotations =
                    annotationStrings(typeBuilder.build().annotations());
        ...
        private void validateOverrideAndRefMethodHelpers(final TypeElement target) {
            ...
            final MethodSpec override = GeneratorUtil.overrideMethod(
                            processingEnv, target, convert, List.of("unchecked"), true)
                    .build();
            ...
            assertTrue(overrideAnnotations.stream()
            ...
            final MethodSpec ref =
                    GeneratorUtil.refMethod(processingEnv, target, convert).build();
            assertTrue(annotationStrings(ref.annotations()).contains("@javax.annotation.Nonnull"));

            final MethodSpec refWithSuppressions = GeneratorUtil.refMethod(
                            processingEnv, target, convert, List.of("unchecked"))
                    .build();
            assertTrue(annotationStrings(refWithSuppressions.annotations()).stream()
                    .anyMatch(a -> a.contains("SuppressWarnings") && a.contains("unchecked")));
            assertTrue(annotationStrings(refWithSuppressions.annotations()).contains("@javax.annotation.Nonnull"));

            final MethodSpec primitiveRef = GeneratorUtil.refMethod(
                            processingEnv, target, method(target, "primitiveRef"))
                    .build();
