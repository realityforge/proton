...
public final class StandardProcessorTest
{
  ...
  public void initReadsConfiguredBooleanOptions()
  {
    ...
    processor.init( processingEnvironment( Map.of( "test.defer.unresolved",
                                                   "false",
                                                   "test.debug",
                                                   "true",
                                                   "test.profile",
  ...
  public void debugAndWarningUseConfiguredDiagnosticKinds()
  {
    ...
    processor.init( processingEnvironment( Map.of( "test.debug", "true", "test.warnings_as_errors", "true" ),
                                           messager ) );
  ...
  @Nonnull
  private static ProcessingEnvironment processingEnvironment( @Nonnull final Map<String, String> options,
                                                              @Nonnull final Messager messager )
  {
