...
public final class NamesUtilTest {
    ...
    public void deriveName() {
        assertEquals(
                NamesUtil.deriveName(
                        executableElement("getURLValue", TypeKind.DECLARED), GETTER_PATTERN, SENTINEL, SENTINEL),
                "uRLValue");
        assertEquals(
                NamesUtil.deriveName(
                        executableElement("getName", TypeKind.DECLARED), GETTER_PATTERN, "declaredName", SENTINEL),
                "declaredName");
        assertNull(NamesUtil.deriveName(
                executableElement("fetchName", TypeKind.DECLARED), GETTER_PATTERN, SENTINEL, SENTINEL));
    }

    @Test
    public void getPropertyAccessorName() {
        assertEquals(
                NamesUtil.getPropertyAccessorName(
                        executableElement("getName", TypeKind.DECLARED),
                        GETTER_PATTERN,
                        ISSER_PATTERN,
                        SENTINEL,
                        SENTINEL),
        ...
        assertEquals(
                NamesUtil.getPropertyAccessorName(
                        executableElement("isReady", TypeKind.BOOLEAN),
                        GETTER_PATTERN,
                        ISSER_PATTERN,
                        SENTINEL,
                        SENTINEL),
        ...
        assertEquals(
                NamesUtil.getPropertyAccessorName(
                        executableElement("isReady", TypeKind.DECLARED),
                        GETTER_PATTERN,
                        ISSER_PATTERN,
                        SENTINEL,
                        SENTINEL),
        ...
        assertEquals(
                NamesUtil.getPropertyAccessorName(
                        executableElement("fetchName", TypeKind.DECLARED),
                        GETTER_PATTERN,
                        ISSER_PATTERN,
                        "declaredName",
                        SENTINEL),
    ...
    public void extractName() {
        ...
        assertEquals(
                NamesUtil.extractName(
                        method, m -> m.getSimpleName().toString(), "com.example.Action", "name", SENTINEL, SENTINEL),
                "doStuff");
        assertEquals(
                NamesUtil.extractName(method, m -> "ignored", "com.example.Action", "name", SENTINEL, "customName"),
                "customName");
    }
