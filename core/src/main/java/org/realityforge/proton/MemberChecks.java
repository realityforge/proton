...
public final class MemberChecks {
    ...
    public static void mustBeClassOrInterface(@Nonnull final String annotationName, @Nonnull final TypeElement element)
            throws ProcessorException {
    ...
    public static void mustNotHaveTypeParameters(
            @Nonnull final String annotationName, @Nonnull final TypeElement element) throws ProcessorException {
        if (!element.getTypeParameters().isEmpty()) {
            throw new ProcessorException(mustNot(annotationName, "have type parameters"), element);
        }
    }

    public static void mustNotBeNonStaticNestedType(
            @Nonnull final String annotationName, @Nonnull final TypeElement element) throws ProcessorException {
    ...
    public static void mustNotHaveAnyParameters(
            @Nonnull final String annotationName, @Nonnull final ExecutableElement method) throws ProcessorException {
        if (!method.getParameters().isEmpty()) {
            throw new ProcessorException(mustNot(annotationName, "have any parameters"), method);
        }
    }

    public static void mustNotHaveAnyTypeParameters(
            @Nonnull final String annotationName, @Nonnull final ExecutableElement method) throws ProcessorException {
    ...
    public static void mustNotReturnAnyValue(
            @Nonnull final String annotationName, @Nonnull final ExecutableElement method) throws ProcessorException {
    ...
    public static void mustNotThrowAnyExceptions(
            @Nonnull final String annotationName, @Nonnull final ExecutableElement method) throws ProcessorException {
    ...
    @Nonnull
    public static String suppressedBy(
            @Nonnull final String warning, @Nullable final String alternativeSuppressWarnings) {
