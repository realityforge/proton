  ...
  extends AbstractStandardProcessor
{
  ...
  {
    if ( !_generated && !env.processingOver() && !env.getElementsAnnotatedWith( GenerateType.class ).isEmpty() )
    {
      _generated = true;
  ...
  private void generateType()
    throws IOException
  {
    emitTypeSpec( "com.example.generated",
                  TypeSpec
                    .classBuilder( "GeneratedModel" )
                    .addModifiers( Modifier.PUBLIC, Modifier.FINAL )
                    .addMethod( MethodSpec
                                  .methodBuilder( "message" )
                                  .addModifiers( Modifier.PUBLIC, Modifier.STATIC )
                                  .returns( String.class )
                                  .addStatement( "return $S + $S + $S + $S + $S + $S + $S + $S + $S",
                                                 "alpha",
                                                 "beta",
                                                 "gamma",
                                                 "delta",
